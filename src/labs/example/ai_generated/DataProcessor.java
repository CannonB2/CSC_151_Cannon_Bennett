...
@Date: 4/20/2026
@purpose: Practice in debugging

Comments for compiling and running so I don't forget/can just copy and paste it
Javac -d bin src/labs/example/ai_generated/*.java
Java -cp bin labs/example/ai_generated/DataProcessor
*/
...
public class DataProcessor {
    ...
    public void addDataEntry(String entry) {
        if (dataEntries.size() < this.maxDataPoints) {
